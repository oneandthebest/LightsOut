  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className='neon-magenta'>Made By</div>
        <div className='neon-magenta'>L e v a n</div>
        <div className='neon-magenta'>P a n t s u l a i a</div>
      </div>
    );
  }
}
